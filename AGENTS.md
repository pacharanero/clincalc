...
- `spec/multilingual.md` - multilingual design and rollout (English by default; translations are advertised only after recorded native-speaker clinical review).
