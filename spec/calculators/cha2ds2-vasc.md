...
Verified 2026-07-28, with the public S2 interface re-checked 2026-08-24, against MedikQuantis's actual source at commit [`cf5afb9`](https://github.com/laurapiro17/medikquantis/blob/cf5afb993fb900d28542b39ae022df6932e34076/packages/calculators/src/cha2ds2vasc.ts) (`packages/calculators/src/cha2ds2vasc.ts`, MIT-licensed, public repo), not just its published description. Pinned to this commit rather than `main` so the citation stays valid if their files change later.
...
- **S2 criterion - point value agrees, full semantic scope remains unconfirmed**: MedikQuantis exposes this input only as an undocumented boolean `strokeOrTia`. Its pinned [English UI](https://github.com/laurapiro17/medikquantis/blob/cf5afb993fb900d28542b39ae022df6932e34076/apps/web/messages/en.json#L165-L174) and [Spanish UI](https://github.com/laurapiro17/medikquantis/blob/cf5afb993fb900d28542b39ae022df6932e34076/apps/web/messages/es.json#L165-L174) label it **"Prior stroke or TIA"** / **"Ictus o AIT previo"**, and its [tests](https://github.com/laurapiro17/medikquantis/blob/cf5afb993fb900d28542b39ae022df6932e34076/packages/calculators/tests/cha2ds2vasc.test.ts#L40-L42) exercise only that label and the 2-point value. This shows that systemic arterial thromboembolism is not communicated or explicitly tested in the public interface, but absence from a short label does not establish an intentional exclusion. `clincalc` explicitly counts stroke, TIA, or systemic arterial thromboembolism and excludes venous thromboembolism (DVT or PE). Confirmation of MedikQuantis's intended boundary still requires an authoritative definition, author confirmation, or an explicit systemic-embolism boundary test; `COLL-001.1` remains open.
...
- Confirm whether MedikQuantis's `strokeOrTia` criterion intentionally includes or excludes systemic arterial thromboembolism before completing `COLL-001.1`.
