...
- **CLI** - `clincalc calc <name> --schema` already prints the definitions; a future `clincalc calc <name> --define <field>` pretty-printer would be a thin convenience on top. The fillable template marks fields that carry a definition.
