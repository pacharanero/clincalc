...
Shipped anthropometric and body-composition measures include BMI, body-fat circumference, Jackson-Pollock skinfolds, BAI, WHtR, WHR, RFM, FFMI, SMI, 1RM, training zones, and the Wilks score. Remaining non-MedikQuantis candidates include other lab or field methods for body composition and the alternative DOTS strength score.
...
- [ ] **CALC-067 Durnin-Womersley 4-site skinfold body fat %** - caliper-derived body-fat estimate for training and body-comparison settings, using the age-banded 4-site (biceps, triceps, subscapular, suprailiac) equations. The shipped `jackson_pollock_skinfold` calculator completed the Jackson-Pollock part of the original CALC-048 candidate; the distinct remaining method has this new stable identifier.
