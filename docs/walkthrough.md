...
!!! tip "How to read this page"
    Each section follows the same shape: **discover** the calculator, **ask** it for a template, **fill** the template, **compute**. Once you've done it once, you've done all 43 active calculators.
...
- Browse the full [Calculator catalogue](calculators.md) - 43 active calculators plus 10 named-but-unavailable.
