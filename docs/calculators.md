...
| `body_adiposity_index` | Body Adiposity Index (BAI) | Weight-free estimate of whole-body fat percentage from height and hip circumference (Bergman 2011), fit and validated against DXA in Mexican-American and African-American adults aged 20-50. Not confirmed in other ethnic groups or in children, and does not provide a diagnostic obesity cut-point. | `primary-care`, `endocrinology`, `screening` |
