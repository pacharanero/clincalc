...
| `protein_target` | Resistance-Training Protein Target | Daily protein target (1.6-2.2 g/kg total body weight/day) from Morton et al 2018's meta-regression break point for resistance-training-induced fat-free-mass gain in healthy adults. Not a general dietary minimum and not validated specifically for a caloric deficit. | `primary-care`, `endocrinology`, `musculoskeletal` |
